...
template <> constexpr inline auto CentralWidget::qt_create_metaobjectdata<qt_meta_tag_ZN13CentralWidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "sliceRequested",
        "",
        "sendToPrintRequested"
    };

    QtMocHelpers::UintData qt_methods {
        // Signal 'sliceRequested'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'sendToPrintRequested'
...
void CentralWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sliceRequested(); break;
        case 1: _t->sendToPrintRequested(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CentralWidget::*)()>(_a, &CentralWidget::sliceRequested, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (CentralWidget::*)()>(_a, &CentralWidget::sendToPrintRequested, 1))
            return;
    }
}
...
// SIGNAL 0
void CentralWidget::sliceRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CentralWidget::sendToPrintRequested()
{
